...
<body>
    <div>
        ...
        <div class="news">
            <?php
                try {
                    $bdd = new PDO('mysql:host=localhost:3306;dbname=ojtb5163_testDB;charset=utf8', '	
                    ojtb5163_groupecfr_lecture', 'P6ea0c3_!Mxr', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
                } catch (Exception $e) {
